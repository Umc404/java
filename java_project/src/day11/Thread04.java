...
class HongWife extends Thread {
	...
	@Override
	public void run() {
		System.out.println("HongWife 출금 시작");
...
public class Thread04 {
	...
	public static void main(String[] args) {
		// 순서를 바꾸려면 main 안 start 순서를 바꾸면 됨.
		...
		/* critical section(임계 영역)은 두 개 이상의 thread가
		 * 동시에 접근할 수 있는 영역(공유 영역)
		 * 동시에 여러개의 thread가 접근하여 공유영역을 가지려고 하면 문제 발생할 수 잇음.
		 * 교착상태(deadlock)가 발생
		 * 한 순간에는 하나의 thread만 사용 가능 : 세마포어(semaphore)
