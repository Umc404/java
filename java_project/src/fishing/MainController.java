...
public class MainController {
	...
	private void printMain(int num) {
		userInfo(num);
		while(flag) {
			System.out.println("메뉴 선택하세요.");
			System.out.println("1. 낚시 2. 랭킹 3. 가방  4. 상점 5. 종료");
			System.out.println("userNum : " + usernum);
			int menu = scan.nextInt();
			
			switch(menu) {
			case 1: test1(); break;					//
			case 2: ranking(usernum); break;					// 
			case 3: inventory(usernum); break;					// 가방
			case 4: store(usernum); break;					// 상점
			case 5: 
				System.out.println("종료");
				flag = false; break;
			default: System.out.println("어허 어디가세요.");
			}
...
//		
		...
		List<Inventory> list = svc.getInven(userNum);
